...
def wall_following_solve():
    while True:
        if front_wall():
            ...
            turn_right()
            move_forward()
        elif not front_wall() and not left_wall() and right_wall():
            print("Right corner detected.")
            turn_right()
            move_forward()
        elif not front_wall() and not right_wall() and left_wall():
            ...
            if left_wall():
                ...
                print("No wall detected on the left, turning left.")
                turn_left()
